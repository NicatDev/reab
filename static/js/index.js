...
function websdkready() {
  ...
  var CLIENT_ID = "4I733jh3SyquflSDovstbg";
  /**
   ...
   */
  var CLIENT_SECRET = "xC003BLtOlrfO9dMJQYP572LARyOi8YG";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSDKSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "/static/js/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
